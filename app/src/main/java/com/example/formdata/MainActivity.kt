...
fun TampilLayout(modifier: Modifier = Modifier) {
    Card (
        ...
        Column(
            ...
            Divider()
            Text(text = "Create Your Account", fontWeight = FontWeight.Bold, fontSize = 20.sp)
            TampilForm()
        }
...
fun TampilForm(cobaViewModel: CobaViewModel = viewModel()){
    ...
    Button(
        modifier = Modifier.fillMaxWidth(),
        onClick = {
            cobaViewModel.insertData(textNama,textTlp,textEml, dataForm.sex, textAlt)
        }
    ) {
        Text(
...
@Composable
fun TextHasil(namanya: String, teleponnya: String,emailnya: String, jenisnya: String, alamatnya: String){
    ElevatedCard (
